...
export const GET_SLIPTEST_CHECK = 'monitoring/get_sliptest_results';
...
export const SAVE_TEACHER_TASK = 'teacher/save_teacher_task';
export const CANCEL_TEACHER_TASK = 'teacher/cancel_teacher_task';
